...
charts = [
    ...
    {
        'source': 'https://raw.githubusercontent.com/monitoring-mixins/website/master/assets/thanos/dashboards/receive.json',
        'destination': '../templates/grafana/dashboards-1.14',
        'type': 'json',
        'min_kubernetes': '1.14.0-0',
    },
    {
        'source': 'https://raw.githubusercontent.com/monitoring-mixins/website/master/assets/thanos/dashboards/query.json',
        'destination': '../templates/grafana/dashboards-1.14',
        'type': 'json',
        'min_kubernetes': '1.14.0-0',
    },
    {
        'source': 'https://raw.githubusercontent.com/etcd-io/website/main/content/en/docs/v3.4/op-guide/grafana.json',
        'destination': '../templates/grafana/dashboards-1.14',
        'type': 'json',
        'min_kubernetes': '1.14.0-0'
    },
...
condition_map = {
    ...
    'receive': '.Values.kubecube.thanos.receive.enabled',
    'query': '.Values.kubecube.thanos.query.enabled'
}
